...
namespace LibOSB.Model.ActionType
{
    class TriggerOld : Action
    {
        ...
        public TriggerOld this[int index]
        {
            get
            {
                return T[index];
        ...
        public TriggerOld(string triggerType, int starttime, int endtime, int i = -1)
        {
            type = "T";
            indexT = i;
